...
private:
    ...
    bool applyAdjacencyJsonEdit(const Mandala& mandala, bool shouldExist, int regionA, int regionB) const;
    bool applyAdjacencyJsonRemoveAllForRegion(const Mandala& mandala, int regionId) const;
    bool applyRegionBlackoutJsonEdit(const Mandala& mandala, int regionId) const;
